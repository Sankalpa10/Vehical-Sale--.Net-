...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2022 at 04:07 PM
...
('root', '[{\"db\":\"vehicle sale\",\"table\":\"sold\"},{\"db\":\"vehicle sale\",\"table\":\"maintance\"},{\"db\":\"vehicle sale\",\"table\":\"forsale\"}]');
...
('root', '2022-11-25 15:07:18', '{\"Console\\/Mode\":\"collapse\"}');
...
USE `test`;
--
-- Database: `vehicle sale`
--
CREATE DATABASE IF NOT EXISTS `vehicle sale` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `vehicle sale`;
...
CREATE TABLE `forsale` (
  ...
  `manuyear` int(5) NOT NULL,
  `regyear` int(5) NOT NULL,
